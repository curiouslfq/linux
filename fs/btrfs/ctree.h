...
BTRFS_SETGET_STACK_FUNCS(stack_disk_key_objectid, struct btrfs_disk_key,
			 objectid, 64);
BTRFS_SETGET_STACK_FUNCS(stack_disk_key_offset, struct btrfs_disk_key, offset, 64);
...
BTRFS_SETGET_STACK_FUNCS(stack_root_dirid, struct btrfs_root_item, root_dirid, 64);
...
BTRFS_SETGET_STACK_FUNCS(stack_root_used, struct btrfs_root_item, bytes_used, 64);
...
BTRFS_SETGET_STACK_FUNCS(stack_backup_chunk_root_gen, struct btrfs_root_backup,
		   chunk_root_gen, 64);
BTRFS_SETGET_STACK_FUNCS(stack_backup_chunk_root_level, struct btrfs_root_backup,
		   chunk_root_level, 8);
...
BTRFS_SETGET_STACK_FUNCS(stack_backup_extent_root_gen, struct btrfs_root_backup,
		   extent_root_gen, 64);
BTRFS_SETGET_STACK_FUNCS(stack_backup_extent_root_level, struct btrfs_root_backup,
		   extent_root_level, 8);
...
BTRFS_SETGET_STACK_FUNCS(stack_super_cache_generation, struct btrfs_super_block,
			 cache_generation, 64);
BTRFS_SETGET_STACK_FUNCS(stack_super_magic, struct btrfs_super_block, magic, 64);
BTRFS_SETGET_STACK_FUNCS(stack_super_uuid_tree_generation, struct btrfs_super_block,
